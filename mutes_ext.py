...
def check_external_trigger_data(pulse_runnum):
...
class Spill():
    MIN_SPILLS = 50
    def __init__(self, ds, extrn_trig_rowc=None, extrn_trig_rowc_as_sec=None):
        self.ds = ds
    ...
    def spill_starts(self):
        spill_start_inds = []
        spill_end_inds = []
        for i, sec in enumerate(self.external_trigger_rowcount_as_seconds):
